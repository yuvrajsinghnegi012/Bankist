...
const account3 = {
  owner: 'John Williams',
  movements: [-5000, 3400, 150, -230, 4310, -2000, 6200, -30],
  interestRate: 1.4,
  pin: 3333,
...
const account4 = {
  owner: 'John Cena',
  movements: [485, -2365.23, -3606.5, 51000, -642.21, -133.9, 79.97, 1300],
  interestRate: 1.2, // %
  pin: 4444,
...
// Displying Login Details
alert("Credentials For Login:\nUsername - PIN\njs - 1111\njd - 2222\njw - 3333\njc - 4444");
...
const formatDisplayDate = function (date, locale) {
  ...
  else if (daysPassed <= 7) return 'THIS WEEK';
  else {
